export const SIGNUP_SERVICE = `/api/sign-up`
export const CHECK_USERNAME_UNIQUE_SERVICE = `/api/check-username-unique`
export const VERIFY_CODE_SERVICE = `/api/verify-code`
