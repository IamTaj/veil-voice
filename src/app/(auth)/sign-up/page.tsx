...
import { CrossIcon, EyeIcon, EyeOffIcon, Loader2 } from "lucide-react"
import {
      ...
      if (userName) {
        ...
        try {
          const response = await axios.get(
            `${CHECK_USERNAME_UNIQUE_SERVICE}?username=${userName}`,
          )
    ...
    <div className="flex-grow flex flex-col items-center px-4 md:px-24 py-12 justify-center item-center min-h-screen bg-gray-100">
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        <div className=" text-center">
          ...
          <p className="mb-4">
            Sign up to start exploring the world of Veil Voice, where your
